...
const STATS_BASE = "https://api.sportsdata.io/api/nba/fantasy/json";
const ODDS_BASE = "https://api.sportsdata.io/api/nba/odds/json";
...
const getGamesForDate = async (dateLabel, dateValue) => {
  const games = await fetchSportsData(`${ODDS_BASE}/GamesByDate/${dateValue}?key=${SPORTS_KEY}`);
const events = [];
