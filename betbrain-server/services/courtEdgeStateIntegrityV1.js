...
export const ALLOWED_TRANSITIONS = Object.freeze({
  ...
  // Home→Results→History lock: Lab stage removed for future transitions.
  // IN_LAB remains readable for historical records only.
  [LIFECYCLE.GRADED_COMPLETE]: [LIFECYCLE.IN_HISTORY, LIFECYCLE.IN_LAB],
