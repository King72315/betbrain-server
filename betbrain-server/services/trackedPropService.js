...
function mapPickToTrackedFields(pick = {}) {
  ...
  const baseFields = {
    ...
    wnbaGateVersion: pick.wnbaGateVersion ?? pick.qualityGateVersion ?? null,
    wnbaTrackingDecision: pick.wnbaTrackingDecision ?? pick.trackingEligibility ?? null,
    wnbaTrackingReason: pick.wnbaTrackingReason ?? null,
    wnbaSideGate: pick.wnbaSideGate ?? null,
    sideGatePassed: pick.sideGatePassed ?? null,
    dangerGateStack: pick.dangerGateStack ?? null,
    dangerGateCount: pick.dangerGateCount ?? null,
    limitedDataPenalty: pick.limitedDataPenalty ?? null,
    underFragilityPenalty: pick.underFragilityPenalty ?? null,
    overVolumePenalty: pick.overVolumePenalty ?? null,
    roleStabilityScore: pick.roleStabilityScore ?? null,
    volumeStabilityScore: pick.volumeStabilityScore ?? null,
    minutesStabilityScore: pick.minutesStabilityScore ?? null,
    marketConfidenceScore: pick.marketConfidenceScore ?? null,
    projectionReliabilityScore: pick.projectionReliabilityScore ?? null,
    fairLineReliabilityScore: pick.fairLineReliabilityScore ?? null,
    finalTrackScore: pick.finalTrackScore ?? pick.qualityGateScore ?? null,
    riskCeilingReason: pick.riskCeilingReason ?? null,
    ...
    sideRescue: pick.sideRescue ?? null,
    sideRescueVersion:
      pick.sideRescueVersion ?? pick.sideRescue?.version ?? null,
