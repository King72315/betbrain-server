...
export function toProductTruthCard(record = {}) {
  ...
  return {
    ...
    freezeTimestamp: record.freezeTimestamp || record.frozenAt || null,
    frozenPredictionFields: record.frozenPredictionFields || null,
    pOver: record.pOver ?? null,
    pUnder: record.pUnder ?? null,
    expectedMinutes: record.expectedMinutes ?? null,
    safetyVersion: record.safetyVersion || null,
    riskVersion: record.riskVersion || null,
    probabilityCalibrationVersion: record.probabilityCalibrationVersion || null,
    membershipQualificationStatus: record.membershipQualificationStatus || null,
    bookCount: record.bookCount ?? null,
    marketQuality: record.marketQuality || null,
    projectionGap: record.projectionGap ?? null,
