...
export function selectControlledBestBoardViaProbabilitySafetyV1(
  ...
  const preliminary = {
    ...
    audit: {
      ...
      highBlocked: membership.highBlocked,
      researchUniverse: membership.research?.counts || null,
      correlationAudit: correlation,
      quarantine,
      boardSizePolicy:
        membership.boardSizePolicy || "SAFEST_TOP_N_EDUCATED_GUESS",
      officialBoardMin: membership.officialBoardMin ?? null,
      officialBoardMax: membership.officialBoardMax ?? null,
